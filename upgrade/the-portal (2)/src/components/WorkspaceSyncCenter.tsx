...
export default function WorkspaceSyncCenter({
  ...
  return (
    <div className="glass-panel border border-white/[0.04] p-6 text-left rounded-2xl space-y-6">
      ...
      {/* Auth Screen or Main Tabbed Workspace */}
      {needsAuth ? (
        <div className="rounded-2xl p-6 border border-dashed border-purple-500/20 bg-purple-500/[0.02] flex flex-col items-center justify-center text-center space-y-5 py-10">
