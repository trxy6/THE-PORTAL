        ...
        <div className="flex items-center justify-between w-full sm:w-auto gap-4">
          ...
          <button 
            onClick={() => {
              ...
              localStorage.setItem(`portal_profile_${userId}`, JSON.stringify(skippedProfile));
              onComplete(skippedProfile);
            }}
            className="px-2.5 py-1 rounded-lg bg-purple-900/40 border border-purple-500/30 hover:border-purple-400 hover:bg-purple-900/60 transition-all text-white flex items-center gap-1.5 cursor-pointer text-[9px] font-extrabold uppercase tracking-wider ml-auto sm:ml-0"
          >
            Skip Onboarding
          </button>
        </div>
