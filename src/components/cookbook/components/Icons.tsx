...
export const SushiIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...iconProps}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20 12V5.5a2.5 2.5 0 10-5 0V12M14 12v-2a2.5 2.5 0 10-5 0v2m-2.5-4.5V12M4 12v3a2.5 2.5 0 005 0v-3m2.5 4.5V12" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 17h16" />
    </svg>
);

export const TacosIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...iconProps}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 12c0-4.418 4.03-8 9-8s9 3.582 9 8-4.03 8-9 8-9-3.582-9-8zm11 0a2 2 0 11-4 0 2 2 0 014 0z" />
...
export const GroupIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-8 h-8 ${className}`}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5zM3 13.255a3 3 0 013-3h3.75a3 3 0 013 3v.502a3 3 0 01-3 3h-3.75a3 3 0 01-3-3v-.502z" />
    </svg>
);

export const CutleryIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={`w-5 h-5 ${className}`}>
        <path d="M7.25 3.25A.75.75 0 006.5 4v11.5c0 .414.336.75.75.75h.25a.75.75 0 000-1.5H7.5V4a.75.75 0 00-.25-.75z" />
        <path d="M12.25 3.25a.75.75 0 00-.75.75v11.5c0 .414.336.75.75.75h.04a.75.75 0 00.74-1.5H12.5V4a.75.75 0 00-.25-.75z" />
        <path fillRule="evenodd" d="M16 8a.75.75 0 00-.75-.75h-1A.75.75 0 0013.5 8v8a.75.75 0 00.75.75h1a.75.75 0 00.75-.75V8zM15 3.25a.75.75 0 00-.75.75v1.5a.75.75 0 001.5 0v-1.5a.75.75 0 00-.75-.75z" clipRule="evenodd" />
    </svg>
);
...
export const CraveIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...navIconProps}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
    </svg>
);

export const FeedIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...navIconProps}>
...
export const BellIcon = ({ hasNotification }: { hasNotification?: boolean }) => (
    <div className="relative">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7">
            <path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0" />
        </svg>
        {hasNotification && (
            <span className="absolute top-0 right-0 block h-2.5 w-2.5 rounded-full bg-red-500 ring-2 ring-cream"></span>
        )}
    </div>
);
